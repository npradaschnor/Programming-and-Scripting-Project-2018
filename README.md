...
_Seaborn_ - great package to make the data visualizations very compelling.
_Sklearn_ - package important to do machine learning in python.

__http://www.philipkalinda.com/ds3.html__
...
:arrow_right: Print all styles available (Matplot)
 ...
 Then, I ran simple descriptive staatistics on iris data set. That way, I could effectively appproach the iris data set.
  ...
  :arrow_right: Pivot table: tool used to organize and summarize data between databases. It facilitates rotational, pivotal and/or structural changes.
...
__https://whatis.techtarget.com/definition/scatter-plot__
